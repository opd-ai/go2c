...
// detectStringUsage detects if the module uses strings and sets the needsStringSupport flag
func (e *Emitter) detectStringUsage(module *llvm.Module) {
	...
	for _, global := range module.Globals {
		...
		// Also check for string type indicators
		if strings.Contains(global.Type, "x i8") {
			e.needsStringSupport = true
			return
		}
	}
